        ...
        <div class="container" id="container">
            ...
            <div class="breadcrumb-pageheader p-b-25">
                <ol class="breadcrumb sm-breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ action('ReportController@stockInReport') }}">Stock In
                            Report</a></li>
                </ol>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="sm-wrapper">
                            <div class="sm-box">
                                <form action="{{ action('ReportController@stockInReport') }}"
                    ...
                    <div class="col-lg-12">
                        <div class="sm-wrapper">
                            <div class="sm-box">
                                ...
                                @include('admin._partials.pagination', ['collection' => $stockIns])
                                    ...
                                    @foreach($stockIns as $index => $stockIn)
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a class="btn btn-primary"
                                                   href="{{ action('ReportController@stockInReportDetail', $stockIn->id) }}">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
