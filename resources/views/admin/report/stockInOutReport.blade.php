    ...
    <div class="container" id="container">
        ...
        <div class="breadcrumb-pageheader p-b-25">
            <ol class="breadcrumb sm-breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/stockinoutreport">Stock In/Out Report</a></li>
            </ol>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sm-wrapper">
                        <div class="sm-box">
                            <form action="{{ action('ReportController@stockInOutReportFilter') }}" class="form-horizontal form-bordered" method="post">
