                ...
                <div class="sm-content-box">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 mt--180">
                            <form class="form-default" action="{{ action('InspectController@searchItems') }}" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-body">
                                                                    ...
                                                                    <table id="data-table"
                                                                        ...
                                                                        @foreach($items as $item)
                                                                            <tr>
                                                                                ...
                                                                                <td width="20%">
                                                                                    <a href="{{ action('InspectController@create', $item->id) }}" class="btn btn-outline-primary">Create Inspect</a>
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
                                                                        @endif
