...
@section('title', 'View Transfer Detail')
        ...
        <div class="container" id="container">
            ...
            <div class="breadcrumb-pageheader">
                <ol class="breadcrumb sm-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Transfer Detail Form</li>
                </ol>
                <h6 class="sm-pagetitle--style-1 has_page_title">Transfer Detail Form</h6>
            </div>
            <!--END BREADCRUMB-->
                                            ...
                                            <ul class="nav nav-tabs justify-content-center"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a href="#tabTwo-1"
                                                       ...
                                                       class="nav-link active text-normal strong-600">Transfer Detail</a>
                                                </li>
                                            </ul>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="voucherNo" placeholder="Enter Voucher"
                                                               type="text" class="form-control" name="voucherNo" value="{{ $transfer->voucherNo }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group has-feedback">
                                                        ...
                                                        <input id="location" placeholder="Enter Location"
                                                               type="text" class="form-control" name="location" value="{{ $transfer->location->name }}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Tab panes -->
                                                    ...
                                                    <table class="table table-cart">
                                                        ...
                                                        <tr>
                                                            <td class="product-name" rowspan="3" colspan="5">
                                                                <label for="location_id">Remark</label>
                                                                <textarea name="remark" id="remark"
                                                                          class="form-control"
                                                                          cols="30" rows="3" placeholder="Remark"
                                                                          tabindex="4" readonly>{{ $transfer->remark }}</textarea>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
