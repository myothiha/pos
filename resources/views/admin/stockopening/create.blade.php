...
@section('title', 'Create Stock Opening Data')
                ...
                <div class="sm-content-box">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 mt--180">
                            <form class="form-default" action="{{ action('StockOpeningController@store', $item->id) }}" method="post" enctype="multipart/form-data">
                                <div class="card">
                                    <div class="card-body">
