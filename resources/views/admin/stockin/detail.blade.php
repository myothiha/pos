...
@section('title', 'View StockIn Detail')
        ...
        <div class="container" id="container">
            ...
            <div class="breadcrumb-pageheader">
                <ol class="breadcrumb sm-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">StockIn Detail Form</li>
                </ol>
                <h6 class="sm-pagetitle--style-1 has_page_title">StockIn Detail Form</h6>
            </div>
            <!--END BREADCRUMB-->
                                            ...
                                            <ul class="nav nav-tabs justify-content-center"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a href="#tabTwo-1"
                                                       ...
                                                       class="nav-link active text-normal strong-600">StockIn Detail</a>
                                                </li>
                                            </ul>
                                            <div class="row">
                                                <div class="col-6">
                                                        ...
                                                        <tr>
                                                            <td class="product-name" rowspan="3" colspan="5">
                                                                ...
                                                                <textarea name="remark" id="remark"
                                                                          ...
                                                                          tabindex="4" readonly>{{ $stockIn->remark }}</textarea>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
